...
export default function AccountSettings() {
  ...
  async function onSaveEmail() {
    try {
      ...
      showAlert({
        message: "If required, confirm the change from the verification email.",
        type: "warning",
      });
    } catch (e) {
  ...
  async function onSavePassword() {
    try {
      ...
      showAlert({ message: "Password updated.", type: "success" });
    } catch (e) {
          ...
          <button
            ...
            onClick={() => {
              showConfirm({
                ...
                onConfirm: async () => {
                  showAlert({
                    message: "Delete account: wire this to your backend.",
                    type: "warning",
                  });
                },
                //
